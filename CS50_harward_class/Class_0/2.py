...
#by taking instructions you can do operations, but to hand gack a product after operations is called return
#not to be confused to changes made to existing data

#manually entering values into prgram is problem? Enter values through terminal?
#use Input
